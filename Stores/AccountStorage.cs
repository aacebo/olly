...
public interface IAccountStorage
{
    ...
    Task<Account?> GetByExternalId(AccountType type, string externalId, CancellationToken cancellationToken = default);
...
public class AccountStorage(ILogger<IAccountStorage> logger, QueryFactory db) : IAccountStorage
{
    ...
    public async Task<Account?> GetByExternalId(AccountType type, string externalId, CancellationToken cancellationToken = default)
    {
